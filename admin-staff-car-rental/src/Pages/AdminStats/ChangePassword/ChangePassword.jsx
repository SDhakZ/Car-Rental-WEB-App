...
export const ChangePassword = () => {
  ...
  const passwordValidation = Yup.object().shape({
    ...
    re_password: Yup.string()
      .oneOf([Yup.ref("new_password")], "Passwords did not match")
            ...
            <Form>
              <div className={CPCSS["CP-form"]}>
                <div className={CPCSS["CP-group"]}>
                  <label htmlFor="old_password" className={CPCSS["CP-label"]}>
                    Old Password
                  </label>
                ...
                <div className={CPCSS["CP-group"]}>
                  <label htmlFor="new_password" className={CPCSS["CP-label"]}>
                    New Password
                  </label>
                  <div className={CPCSS["CP-password"]}>
                    <Field
                ...
                <div className={CPCSS["CP-group"]}>
                  <label htmlFor="re_password" className={CPCSS["CP-label"]}>
                    Re-enter Password
                  </label>
                  <div className={CPCSS["CP-password"]}>
                    <Field
                    ...
                    >
                      <i
                        className={`fas ${
                          repasswordVisible ? "fa-eye" : "fa-eye-slash"
                        }`}
                      />
                    </span>
                  </div>
